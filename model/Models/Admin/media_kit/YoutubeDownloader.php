...
class YoutubeDownloader
{
    ...
    private function getVideoInfo(){ 
        ...
        curl_setopt($curl_handle, CURLOPT_URL, "https://youtube.com/get_video_info?video_id=".$this->extractVideoId($this->video_url)."&cpn=CouQulsSRICzWn5E&eurl&el=adunit");
        ...
        dd([
            "https://youtube.com/get_video_info?video_id=".$this->extractVideoId($this->video_url)."&cpn=CouQulsSRICzWn5E&eurl&el=adunit",
            $query
        ]);
        // return file_get_contents("https://youtube.com/get_video_info?video_id=".$this->extractVideoId($this->video_url)); 
    } 
